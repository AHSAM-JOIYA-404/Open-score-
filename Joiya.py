...
try:
    ...
    os.system("xdg-open https://facebook.com/THI.JOIYA.SAAB.302")
   ...
   'authority': 'x.facebook.com',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\x1b[1;97m [\033[1;97mRUNNING-JOIYA🔥\033[1;97m] %s|\x1b[1;92mOK: %s \x1b[1;97m\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
